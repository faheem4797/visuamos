...
class VisionBoardDB {
  ...
  Future<List<VisionBoardData>> _fetchVisionBoardImages() async {
    final db = _db;
    if (db == null) {
      return [];
    }
    try {
      final read = await db.query('visionBoard', orderBy: 'id DESC');
  ...
  Future<bool> addVisionBoardImageData(
    ...
    try {
      ...
      _visionBoardList = await _fetchVisionBoardImages();
  ...
  Future<bool> open() async {
    ...
    try {
      ...
      // read all data
      final visionBoardImagesList = await _fetchVisionBoardImages();
